...
public class BacktestTradeEntity {
    ...
    @Column(nullable = false, precision = 20, scale = 8)
    private BigDecimal pointsPnl; // legacy field: quantity-adjusted P/L value
    ...
    /** Preferred semantic name for the same persisted quantity-adjusted P/L value. */
    public BigDecimal getPnlValue() { return pointsPnl; }
    public void setPnlValue(BigDecimal v) { this.pointsPnl = v; }
